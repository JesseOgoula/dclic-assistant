...
1. Validation administrative (Lettre d'engagement).
...
- Samedi (Session d'accompagnement) : 55 participants.

### B. Bilan organisationnel

**Synthèse des contacts avec les apprenants :**
- **WhatsApp :** Canal principal d'animation. Partage de rappels quotidiens, de liens vers les agendas Google, de tutoriels pour la signature électronique et d'encouragements pour la prise en main de la plateforme.
- **Mails :** Envoi d'un mail de bienvenue détaillé à l'ensemble de la cohorte, suivi d'un mail de relance ciblé aux apprenants inactifs en milieu de semaine. Des tutoriels vidéo ont été intégrés pour faciliter la signature de la lettre d'engagement.
- **Sondage :** Un sondage de disponibilité a été envoyé, récoltant 66 participations, permettant de fixer les deux créneaux hebdomadaires (Mercredi 18h et Samedi 17h GMT). Les liens Google Agenda ont été partagés pour automatiser les rappels.

**Résumé des séances en visioconférence :**
- **Session 1 (Samedi 02/08 – 17h GMT) :**
  - Thématique : Présentation du cadre D-CLIC, méthodologie de travail et introduction à la Séquence 1.
